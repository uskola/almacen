...
if ($_SERVER["HTTP_REFERER"]=="") //SI la pagina se cargo directamente desde la URL y no desde productos
{
	echo mostrar_mensaje_error("Imposible eliminar","Utilice las opciones del sistema.","","<a href='productos.php?num=". $_GET["num"] ."'>Volver al listado</a>");
	exit();
}
...
<table witdh="400" class="style4">
	...
	<tr>
		...
		producto <span class="style5"><?php echo $_GET["codpro"] . " - ".$_GET["nom"]  ?></span>?</strong></td>
		<td style="width: 50px">&nbsp;</td>
	</tr>
	<tr>
		<td style="width: 50px">&nbsp;</td>
		<td style="width: 150px" class="style1">
		<form method="post" action="producto_eliminar.php?codpro=<?php echo $_GET["codpro"]; ?>&num=<?php echo $_GET["num"]; ?>">
			<input name="Submit1" type="submit" value="S&iacute;" title="Clic para eliminar el producto" />&nbsp;&nbsp;&nbsp;
		</form>
		</td>
