...
<table width="800" border="0">
  <tr>
    <td height="18"><div align="center" class="title" >A&Ntilde;ADIR CLIENTE</div></td>
  </tr>
    <tr>
    <td class="style6"><form name="clientes" action="cliente_nuevo_guardar.php" title="Nuevo Cliente" style="border:thin" method="post">
	<table style="width: 100%">
		...
		<tr>
			...
			<td class="style7">
			<input name="representante" type="text" style="width: 73px" class="style10"></td>
		</tr>
		<tr>
          <td style="width: 200px" class="style5">Fecha de creación <span class="style8">*</span></td>
		  <td class="style7"><input name="fecha" type="text" class="style10" id="fecha" size="15" maxlength="10" title="Introduzca la fecha de creación del cliente en el formato dd/mm/yyyy" /> 
